...
message("+----- Addition Figurexx for HFDvsCtrl across time heatmap-----------------------------+")
...
```
Double check Nrp1 high/low clusters,
```{r}
Idents(MAC_Reclustered) <- "integrated_snn_res.1.2"
test <- AverageExpression(object = MAC_Reclustered, group.by = c('ident'))$RNA
